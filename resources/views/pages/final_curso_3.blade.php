      ...
      @endif
                ...
                <div class="panel-body">
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <div class="form-check">
                                <input type="radio" name="p4_6" value="40" {{ (old('p4_6') == '2¿40') ? 'checked' : '' }} class="form-check-input" id="materialUnchecked">
                            </div>
                        </td>
                        <td align="center">
                            <div class="form-check">
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <div class="form-check">
                                <input type="radio" name="p5_8" value="20" {{ (old('p5_8') == '20') ? 'checked' : '' }} class="form-check-input" id="materialUnchecked">
                            </div>
                        </td>
                        <td align="center">
                            <div class="form-check">
                                <input type="radio" name="p5_8" value="40" {{ (old('p5_8') == '40') ? 'checked' : '' }} class="form-check-input" id="materialUnchecked">
                            </div>
                        </td>
                        <td align="center">
                            <div class="form-check">
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <div class="form-check">
                                <input type="radio" name="p5_9" value="20" {{ (old('p5_9') == '20') ? 'checked' : '' }} class="form-check-input" id="materialUnchecked">
                            </div>
                        </td>
                        <td align="center">
                            <div class="form-check">
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <div class="form-check">
                                <input type="radio" name="p6_1" value="20" class="form-check-input" {{ (old('p6_1') == '20') ? 'checked' : '' }} id="materialUnchecked">
                            </div>
                        </td>
                        <td align="center">
                            <div class="form-check">
                                <input type="radio" name="p6_1" value="40" class="form-check-input" {{ (old('p6_1') == '40') ? 'checked' : '' }} id="materialUnchecked">
                            </div>
                        </td>
                        <td align="center">
                            <div class="form-check">
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <div class="form-check">
                                <input type="radio" name="p6_2" value="20" {{ (old('p6_2') == '20') ? 'checked' : '' }} class="form-check-input" id="materialUnchecked">
                            </div>
                        </td>
                        <td align="center">
                            <div class="form-check">
                                <input type="radio" name="p6_2" value="40" {{ (old('p6_2') == '40') ? 'checked' : '' }} class="form-check-input" id="materialUnchecked">
                            </div>
                        </td>
                        <td align="center">
                            <div class="form-check">
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <div class="form-check">
                                <input type="radio" name="p6_3" value="20" {{ (old('p6_3') == '20') ? 'checked' : '' }} class="form-check-input" id="materialUnchecked">
                            </div>
                        </td>
                        <td align="center">
                            <div class="form-check">
                                <input type="radio" name="p6_3" value="40" {{ (old('p6_3') == '40') ? 'checked' : '' }} class="form-check-input" id="materialUnchecked">
                            </div>
                        </td>
                        <td align="center">
                            <div class="form-check">
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <div class="form-check">
                                <input type="radio" name="p6_4" value="20" {{ (old('p6_4') == '20') ? 'checked' : '' }} class="form-check-input" id="materialUnchecked">
                            </div>
                        </td>
                        <td align="center">
                            <div class="form-check">
                                <input type="radio" name="p6_4" value="40" {{ (old('p6_4') == '40') ? 'checked' : '' }} class="form-check-input" id="materialUnchecked">
                            </div>
                        </td>
                        <td align="center">
                            <div class="form-check">
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <div class="form-check">
                                <input type="radio" name="p6_5" value="20" {{ (old('p6_5') == '20') ? 'checked' : '' }} class="form-check-input" id="materialUnchecked">
                            </div>
                        </td>
                        <td align="center">
                            <div class="form-check">
                                <input type="radio" name="p6_5" value="40" {{ (old('p6_5') == '40') ? 'checked' : '' }} class="form-check-input" id="materialUnchecked">
                            </div>
                        </td>
                        <td align="center">
                            <div class="form-check">
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <div class="form-check">
                                <input type="radio" name="p6_6" value="20" {{ (old('p6_6') == '20') ? 'checked' : '' }} class="form-check-input" id="materialUnchecked">
                            </div>
                        </td>
                        <td align="center">
                            <div class="form-check">
                                <input type="radio" name="p6_6" value="40" {{ (old('p6_6') == '40') ? 'checked' : '' }} class="form-check-input" id="materialUnchecked">
                            </div>
                        </td>
                        <td align="center">
                            <div class="form-check">
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <div class="form-check">
                                <input type="radio" name="p6_7" value="20" {{ (old('p6_7') == '20') ? 'checked' : '' }} class="form-check-input" id="materialUnchecked">
                            </div>
                        </td>
                        <td align="center">
                            <div class="form-check">
                                <input type="radio" name="p6_7" value="40" {{ (old('p6_7') == '40') ? 'checked' : '' }} class="form-check-input" id="materialUnchecked">
                            </div>
                        </td>
                        <td align="center">
                            <div class="form-check">
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <div class="form-check">
                                <input type="radio" name="p6_8" value="20" {{ (old('p6_8') == '20') ? 'checked' : '' }} class="form-check-input" id="materialUnchecked">
                            </div>
                        </td>
                        <td align="center">
                            <div class="form-check">
                                <input type="radio" name="p6_8" value="40" {{ (old('p6_8') == '40') ? 'checked' : '' }} class="form-check-input" id="materialUnchecked">
                            </div>
                        </td>
                        <td align="center">
                            <div class="form-check">
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <div class="form-check">
                                <input type="radio" name="p6_9" value="20" {{ (old('p6_9') == '20') ? 'checked' : '' }} class="form-check-input" id="materialUnchecked">
                            </div>
                        </td>
                        <td align="center">
                            <div class="form-check">
                                <input type="radio" name="p6_9" value="40" {{ (old('p6_9') == '40') ? 'checked' : '' }} class="form-check-input" id="materialUnchecked">
                            </div>
                        </td>
                        <td align="center">
                            <div class="form-check">
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <div class="form-check">
                                <input type="radio" name="p6_10" value="20" {{ (old('p6_10') == '20') ? 'checked' : '' }} class="form-check-input" id="materialUnchecked">
                            </div>
                        </td>
                        <td align="center">
                            <div class="form-check">
                                <input type="radio" name="p6_10" value="40" {{ (old('p6_10') == '40') ? 'checked' : '' }} class="form-check-input" id="materialUnchecked">
                            </div>
                        </td>
                        <td align="center">
                            <div class="form-check">
                    ...
                    <tr>
                        ...
                        <td align="center">
                            <div class="form-check">
                                <input type="radio" name="p6_11" value="20" {{ (old('p6_11') == '20') ? 'checked' : '' }} class="form-check-input" id="materialUnchecked">
                            </div>
                        </td>
                        <td align="center">
                            <div class="form-check">
                                <input type="radio" name="p6_11" value="40" {{ (old('p6_11') == '40') ? 'checked' : '' }} class="form-check-input" id="materialUnchecked">
                            </div>
                        </td>
                        <td align="center">
                            <div class="form-check">
