      ...
      @endif
                ...
                <div class="panel-body">
                    ...
                    <tr>
                        ...
                        <td align="center">
                        <div class="form-check">
                                    <input type="radio" name="p6_1" value="20" {{ (old('p6_1') == '20') ? 'checked' : '' }} class="form-check-input" id="materialUnchecked">
                                </div>
                            </td>
                            <td align="center">
                                <div class="form-check">
                                    <input type="radio" name="p6_1" value="40" {{ (old('p6_1') == '40') ? 'checked' : '' }} class="form-check-input" id="materialUnchecked">
                                </div>
                            </td>
                            <td align="center">
                                <div class="form-check">
